...
select  inst1.name as parameter
  ...
  from (select * from gv$parameter where isdefault != 'TRUE' and inst_id=1) inst1
      ,(select * from gv$parameter where isdefault != 'TRUE' and inst_id=2) inst2
	  ,(select * from gv$parameter where isdefault != 'TRUE' and inst_id=3) inst3
	  ,(select * from gv$parameter where isdefault != 'TRUE' and inst_id=4) inst4
