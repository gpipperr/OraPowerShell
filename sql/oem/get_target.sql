...
select t.target_name
	...
	--,tt.type_display_name
	  ...
	  , to_char((select max(mmc.collection_timestamp) from sysman.mgmt$metric_current mmc where mmc.target_guid=t.target_guid),'dd.mm.yyyy hh24:mi') as last_collection 
	 -- , to_char(tlt.first_metadata_load_time,'dd.mm.yyyy hh24:mi') as first_metadata_load_time 
from
     mgmt_targets t
	, mgmt_targets_load_times tlt
