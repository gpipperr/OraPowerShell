...
,sa.sql_text last_sql
 ...
 where sw.event not in
       ('rdbms ipc message', 'smon timer', 'pmon timer', 'SQL*Net message from client',
        'lock manager wait for remote message', 'ges remote message', 'client message', 'pipe get', 'Null event',
        'PX Idle Wait', 'single-task message', 'PX Deq: Execution Msg', 'KXFQ: kxfqdeq - normal deqeue',
        'listen endpoint status', 'slave wait', 'wakeup time manager', 'jobq slave wait','Space Manager: slave idle wait'
		...
		,'VKRM Idle','VKTM Logical Idle Wait','DIAG idle wait' )
